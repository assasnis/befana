      ...
      <div class="panel-body">
        <?php
          ...
          foreach ($orden->result() as $ordenes) {
              ...
              $url_aprobar = base_url() . 'index.php/Gerente_control/pago_aprobado?id='.$ordenes->producto;
              ...
              echo ' ¿Esta seguro que desea aprobar el pago?';
              echo '      </div>';
              echo '      <div class="modal-footer">';
              echo '        <button type="button" class="btn btn-default" data-dismiss="modal">Cerrar</button>';
              echo '        <a href="' . $url_aprobar . '" "#" class="btn btn-success" role="button">Aprobar pago</a>';
              echo '      </div>';
              echo '    </div>';
              echo '  </div>';
              echo '</div>';
